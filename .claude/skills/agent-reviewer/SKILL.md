...
Àmbit de la revisió: $ARGUMENTS (si buit, revisa tot el projecte)
...
Endpoints que **NO** necessiten auth: `app/api/auth/login`, `app/api/auth/logout`.
...
- Crides a Binance o SQLite directament dins de components React
- Hex colors hardcoded en `app/styles/dashboard.css` fora dels tokens aprovats
